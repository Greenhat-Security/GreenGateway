...
/// slot can be reclaimed at the TTL. Shared with the discovery projector and
/// the maintenance singleton (`cluster_maintenance.rs`), whose leader terms
/// are one long-held lease renewed the same way.
