...
The connection-management collection, detail, and refresh routes follow the same dynamic prefix: `/v1{ADMIN_PREFIX}/connections`, `/v1{ADMIN_PREFIX}/connections/{id}`, and `/v1{ADMIN_PREFIX}/connections/{id}/refresh`.
